...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Ahjin_sprt")
                await self.one.join_chat("Ahjin_sprt")
                await self.one.join_chat("Ahjin_sprt")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Ahjin_sprt")
                await self.two.join_chat("Ahjin_sprt")
                await self.two.join_chat("Ahjin_sprt")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Ahjin_sprt")
                await self.three.join_chat("Ahjin_sprt")
                await self.three.join_chat("Ahjin_sprt")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Ahjin_sprt")
                await self.four.join_chat("Ahjin_sprt")
                await self.four.join_chat("Ahjin_sprt")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Ahjin_sprt")
                await self.five.join_chat("Ahjin_sprt")
                await self.five.join_chat("Ahjin_sprt")
            except:
                pass
